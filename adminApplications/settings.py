"""
Django settings for adminApplications project.
...
SECRET_KEY = 'oc@h5-ewv@u+h^$g2ge=!sa(8xz9!vsze&*jmi5(4jchgb9l1-'
...
ROOT_URLCONF = 'adminApplications.urls'

WSGI_APPLICATION = 'adminApplications.wsgi.application'
